...
class ToolFactory:
    ...
    def _search_child_chunks(self, query: str, k: int) -> List[dict]:
        """Search for the top K most relevant document chunks using semantic similarity.
        
        This tool performs vector similarity search on the document collection.
        The query can be in any language - it will be embedded and matched against stored documents.
        
        Args:
            query: Search query string (can be in Chinese, English, or other languages)
            k: Number of top results to return (default: 5)
            
        Returns:
            List of dictionaries containing:
            - content: The text content of the matching chunk
            - parent_id: ID of the parent chunk this belongs to
